...
# منابع داده و اتصال CRM

برنامه دو منبع داده دارد:

- Excel به‌عنوان ورودی پشتیبان و قابل‌انتقال.
- Dynamics 365 On-Premises به‌عنوان منبع فقط‌خواندنی از View انتخاب‌شده.

اتصال فعلی از مسیر زیر انجام می‌شود:
