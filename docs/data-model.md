...
پیشنهادهای بهبود در جدول `ai_improvement_suggestions` با همان Signature ذخیره
می‌شوند. این پیشنهادها از پاسخ تحلیل خوانده می‌شوند و تا زمان تأیید مدیریتی،
هیچ Rule یا امتیازی را تغییر نمی‌دهند.
